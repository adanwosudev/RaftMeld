...
#[derive(Debug)]
pub struct RaftMeldProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RaftMeldProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RaftMeld processing");
    
    let mut processor = RaftMeldProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RaftMeldProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RaftMeldProcessor::new(false);
